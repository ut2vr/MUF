...
if __name__ == '__main__':
    ...
    mail_handler = SSLSMTPHandler(mailhost=('smtp.ukr.net', 465),
                                  fromaddr='ur3vio@ukr.net',
                                  toaddrs=['ut2vr.pm@gmail.com'],
                                  subject='Error',
                                  credentials=('ur3vio@ukr.net', 'k2RgYAoloGWR7p1U'))
    ...
    base_par = base_host, base_user, base_passwd, base_name
